...
We start with a BERT-style transformer pretrained on a large corpus of scientific articles. SciBERT is well-suited to our setting because both the sentences and the reference texts come from scientific papers.
