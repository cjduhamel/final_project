...
\begin{itemize}
    ...
    \item \verb|truncation = "only_second"| (if we need to truncate the input to match the 512 tokens, we only truncate from the ref block and not the original sentence),
...
\begin{itemize}
    ...
    \item Top-2 paragraph accuracy: $10/13 \approx 0.765$.
\end{itemize}
